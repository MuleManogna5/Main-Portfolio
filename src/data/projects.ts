export const projects = [
  {
    ...
    title: "E-Commerce Platform - Veloura Store",
    description:
      "Fashion Store called as <strong>Veloure Store</strong>. A dark-themed fashion e-commerce frontend showcasing multiple product categories.",
    tech: ["HTML", "CSS", "Javascript"],
    github: "https://mulemanogna5.github.io/fashion-store/",
